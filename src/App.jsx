...
function App() {
  ...
  // Mostra il bottone WhatsApp sticky dopo 300px di scroll
  useEffect(() => {
  ...
  return (
    ...
    >
        ...
        <div className="max-w-7xl mx-auto px-4 py-2 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            <NavLink href="#top" className="cursor-pointer">
              ...
              <img src={logoImage} alt="Iremia" className="h-16 md:h-40" />
            </NavLink>
      ...
      {/* Bottone WhatsApp sticky — appare dopo 300px di scroll */}
      <a
        href={whatsappLink}
        target="_blank"
